...
public class SkystoneDetector2 extends DogeCVDetector {         // theres another skystone detector thats causing issues
                                                                // so i put a 2 after this name to fix it
    ...
    public RatioScorer ratioScorer = new RatioScorer(1.25, 1); // Used to find the short face of the stone
    public MaxAreaScorer maxAreaScorer = new MaxAreaScorer( 100);                    // Used to find largest objects
    ...
    public Mat process(Mat input) {
        ...
        // Imgproc.GaussianBlur(workingMat,workingMat,new Size(5,5),0); // not sure
