...
@Autonomous(name = "RedAlliance1Skystone", group = "Autonomous")
//@Disabled
public class RedAlliance1Skystone extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        while(opModeIsActive()){
            ...
            if (pattern.equals("right")){ // go to the middle one
                encoderDrive(-24, 'x', 1, 50, 50);
                encoderDrive(3, 'y', 1, 50, 50);
                //use mech
                encoderDrive(-3, 'y', 1, 50, 50);
